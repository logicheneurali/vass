...
- MCP server with 23 tools for AI orchestration (web, files, events, tags, script execution)
...
aa,xx bb,cc {var}
```
Generates 4 patterns: `aa bb {var}`, `aa cc {var}`, `xx bb {var}`, `xx cc {var}` (2×2 = 4).

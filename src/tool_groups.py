...
TOOL_GROUPS = {
        "web":       ["browse", "webfetch", "websearch", "youtube_search", "search_places", "search_nearby", "search_news", "weather"],
...
def _default_keywords():
    ...
    return {
        "web":       {"cerca", "internet", "sito", "online", "pagina",
                       ...
                       "youtube", "video", "canale", "guarda un video",
                       "guarda su youtube", "clip"},

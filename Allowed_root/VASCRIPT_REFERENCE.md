...
### **`compress_memory`**
Executes the `compress_memory` function.
...
### **`ifgreaterequal` (`if_greater_equal`)**
...
### **`removeevent` (`delete_event`, `delevent`, `remove_event`)**
